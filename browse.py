...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        navtb.setIconSize(PyQt5.QtCore.QSize(16, 16))
    ...
    def navigate_url(self):
        u = PyQt5.QtCore.QUrl(self.urlbar.text())
        try:
            if u.scheme() == "":
                u.setScheme('http')
